...
public class Blinkin extends BlinkinConstants {
    ...
    /**
     * Set a pattern using one of the fixed {@link ColorScheme ColorScheme}'s and {@link FixedPatternType fixed pattern}s.
     * @param scheme {@link ColorScheme ColorScheme} to use; Rainbow, Party, Ocean, Lava, or Forest
     * @param pattern {@link FixedPatternType Pattern}; Rainbow, Sinelon, Beats Per Minute, Twinkles, or Color Wave
     */
    ...
    /**
     * Private method that limits decimal places to 2 for precision and sets them on the Spark object
